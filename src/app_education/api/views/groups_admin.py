...
from utils.permissions import IsAuthenticatedPermission, IsSuperUserPermission, IsAdminUserPermission
...
class AdminFacultyGroupsListCreateView(generics.ListCreateAPIView):
    ...
    def get_permissions(self):
        if self.request.method == 'POST':
            return [IsAuthenticatedPermission(), IsAdminUserPermission(), IsSuperUserPermission()]
